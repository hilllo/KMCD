...
cstu_get_score(jack,maths,85.0).
cstu_get_score(jack,physics,76.0).

%% completed courses' score of previous students
%% fstu_get_score(Student_Name,Course_Name,Score).
%% mike
fstu_get_score(mike,maths,80.0).
fstu_get_score(mike,physics,75.0).
%% hanks
fstu_get_score(hanks,maths,86.0).
fstu_get_score(hanks,physics,72.0).
%% tom
fstu_get_score(tom,maths,88.0).
fstu_get_score(tom,physics,75.0).
%% robbie
fstu_get_score(robbie,maths,85.0).
fstu_get_score(robbie,physics,75.0).
