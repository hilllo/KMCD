...
%% KEY FACTS to KBMC
%% ---------------------------------------------------
%% completed courses' score of current students
%% cstu_get_score(Student_Name,Course_Name,Score).
cstu_get_score(jack,maths,85).
cstu_get_score(jack,physics,76).

%% completed courses' score of previous students
%% fstu_get_score(Student_Name,Course_Name,Score).
%% mike
fstu_get_score(mike,maths,80).
fstu_get_score(mike,physics,75).
%% hanks
fstu_get_score(hanks,maths,86).
fstu_get_score(hanks,physics,72).
%% tom
fstu_get_score(tom,maths,88).
fstu_get_score(tom,physics,75).
%% robbie
fstu_get_score(robbie,maths,85).
fstu_get_score(robbie,physics,75).


%% future courses which has been token by previous students.
%% fstu_take_course(Student_Name,Course_Name,Pass)
%% Pass=1 means pass, Pass=0 means fail.
%% mike
fstu_take_course(mike,os,1).
fstu_take_course(mike,cpp,0).
fstu_take_course(mike,java,1).
fstu_take_course(mike,ai,1).
fstu_take_course(mike,ca,1).
fstu_take_course(mike,ed,0).
%% hanks
fstu_take_course(hanks,os,1).
fstu_take_course(hanks,java,1).
fstu_take_course(hanks,unix,1).
fstu_take_course(hanks,ai,0).
fstu_take_course(hanks,ca,0).
fstu_take_course(hanks,ed,1).
%% tom
fstu_take_course(tom,me,1).
fstu_take_course(tom,cpp,1).
fstu_take_course(tom,ed,1).
%% robbie
fstu_take_course(robbie,me,1).
fstu_take_course(robbie,os,0).
fstu_take_course(robbie,cpp,1).
fstu_take_course(robbie,ca,1).
...
similar_fstu(CStu,FStu):-
	cstu_get_score(CStu,C,M1),
	fstu_get_score(FStu,C,M2),
	M2=<M1+1,M2>=M1-1.
...
main :- fc,m,csecl,bhmt,bhmp,tm,cml.